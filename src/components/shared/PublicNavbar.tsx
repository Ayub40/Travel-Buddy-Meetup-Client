            ...
            <SheetContent side="right" className="w-[300px]">
              ...
              <div className="mt-8 flex flex-col space-y-4">
                ...
                <div className="pt-4 border-t">
                  <p className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wider">Resources</p>
                  {resourceItems.map((res) => (
...
// import Link from "next/link";
// import { Menu, ChevronDown, ShieldAlert, Mail, Info } from "lucide-react";
// import { Button } from "../ui/button";
// import { Sheet, SheetContent, SheetTrigger, SheetTitle } from "../ui/sheet";
// import {
//   DropdownMenu,
...
//   const resourceItems = [
//     { href: "/about", label: "About Us", icon: Info, desc: "Learn about our journey" },
//     { href: "/contact", label: "Contact Support", icon: Mail, desc: "Get in touch with us" },
//     { href: "/privacy", label: "Privacy & Terms", icon: ShieldAlert, desc: "Your data security is our priority" },
//   ];
...
//           <DropdownMenu>
//             <DropdownMenuTrigger className="flex items-center gap-1 px-3 py-2 rounded-full text-gray-700 dark:text-gray-200 hover:text-blue-600 hover:bg-blue-50/50 outline-none transition-all font-medium">
//               Resources <ChevronDown size={14} />
//             </DropdownMenuTrigger>

//             <DropdownMenuContent className="w-52 p-2 rounded-xl bg-white/90 backdrop-blur-lg border border-gray-100 shadow-xl">
//               {resourceItems.map((res) => (
//                 <DropdownMenuItem key={res.label} asChild>
//                   <Link
//                     href={res.href}
//                     className="flex items-center gap-2 p-2 cursor-pointer rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 transition-colors"
//                   >
//                     <res.icon size={16} className="text-blue-600" />
