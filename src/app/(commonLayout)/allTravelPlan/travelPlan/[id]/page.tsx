...
//                 {/* --- Top Header Section (About Page Style Area) --- */}
...
//                     {/* Left Column: Story & Reviews (8 Units) */}
//                     <div className="lg:col-span-8 space-y-12">
//                         {/* Description Section */}
//                         <section className="bg-orange-50/40 p-10 md:p-14 rounded-[3rem] border border-orange-100/50 relative overflow-hidden">
...
//                                             <div className="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center text-purple-600 font-black text-xl flex-shrink-0">
//                                                 {review.user?.name?.charAt(0) || "U"}
//                                             </div>
//                                             <div className="space-y-2">
//                                                 <div className="flex items-center gap-3">
//                                                     <p className="font-black text-gray-800 text-lg">{review.user?.name}</p>
...
//                     {/* Right Column: Organizer & Stats (4 Units) */}
